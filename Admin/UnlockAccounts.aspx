<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UnlockAccounts.aspx.cs" Inherits="Admin_UnlockAccounts" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <label>User Account to Unlock
                    <asp:DropDownList runat="server" ID="cboUserList" CssClass="TextField" /></label>
            <div class="buttons">
                <asp:Button runat="server" ID="btnUnlock" Text="Unlock Account" CssClass="Button" />                        
            </div>
        </div>
        <div class="Error">
