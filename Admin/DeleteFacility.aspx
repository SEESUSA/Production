<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeleteFacility.aspx.cs" Inherits="Admin_DeleteFacility" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <p>Are you sure you want to delete the Facility (<%=API.Session.AdminEHPFacility %>)?</p>
            <div class="buttons">
