<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeleteDoctor.aspx.cs" Inherits="Admin_DeleteDoctor" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <p>Are you sure you want to delete the Doctor (<%=API.Session.AdminEHPDoctor %>)?</p>
            <div class="buttons">
