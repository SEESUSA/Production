<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeleteEHPCPSApptType.aspx.cs" Inherits="Admin_DeleteEHPCPSApptType" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <p>Are you sure you want to delete the GE Appointment (<%=API.Session.AdminGECPSApptType %>) from the EHP Appt Type (<%=API.Session.AdminEHPCPSApptType %>)?</p>
            <div class="buttons">
