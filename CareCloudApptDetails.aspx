<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CareCloudApptDetails.aspx.cs" Inherits="CareCloudApptDetails" %>
...
<body>
    ...
    <form id="form1" runat="server">
       ...
       <%-- <p>Please fax your referral note to our fax number above.</p>--%>
         <p>Please fax your referral note to our office.</p>
        <div class="Error">
            <asp:Literal runat="server" ID="litError" />
            <br />
            
        </div>
        <div style="text-align:center"> <asp:Button ID="btnBack" runat="server" CssClass="Button" Text="Back" OnClick="btnBack_Click" /></div>
